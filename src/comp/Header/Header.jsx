...
const Header = () => {
  return (
    <div className="flex flex-col">
      {" "}
      {/* Top Banner */}{" "}
      <div className="hidden bg-blue-400 lg:flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-10 px-6 lg:px-20 py-6 lg:py-8">
        {" "}
        {/* JNU Logo */}{" "}
        <img
          src={jnuLogo}
        ...
        <div className="flex flex-col text-center text-white font-bold">
          ...
          <p className="text-sm lg:text-base font-normal mt-2">
            ...
            University, <br /> New Delhi-110067, India. <br /> December 20-21,
            2025{" "}
          </p>{" "}
        </div>{" "}
        {/* Atom Logo */}{" "}
