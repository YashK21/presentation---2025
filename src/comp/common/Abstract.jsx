  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="max-w-4xl mx-auto mb-10 text-base sm:text-lg text-gray-700 leading-relaxed space-y-4 text-left md:text-justify">
        ...
        <p>
          For authors who choose to submit a full paper, accepted manuscripts may
          be assigned to affiliated SCI/SCIE & Scopus-indexed journals, based on
          the scope and quality of the work. Full papers submitted to ICRANN-2025
          by the deadline will be evaluated for originality by the committee and
          will undergo the standard peer-review process of the respective
          journals.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto mt-8 mb-12">
        <div className="flex flex-col items-center space-y-4">
          <p className="text-gray-700 text-sm sm:text-base text-center">
            The full paper will be uploaded as a new submission through the CMT
            portal after the conference dates.
          </p>
          ...
          >
            Nano Life — Nanoscience, Biomedicine, and Environmental Health
          </a>
        </div>
      </div>

      {/* ===== Additional Journals Information ===== */}
      <div className="max-w-4xl mx-auto mb-12">
        ...
        <p className="text-gray-700 text-sm sm:text-base mb-4 text-center">
          For your information, participants of ICRANN-2025 will have the
          opportunity to publish their original research work in the following
          journals:
        </p>

        <ul className="list-disc list-inside space-y-2 text-gray-700 text-sm sm:text-base max-w-3xl mx-auto">
          <li>
            <span className="font-medium">Energy Technologies</span> — Device and
            systems advances at the energy/materials interface
          </li>
          <li>
            <span className="font-medium">ChemNanoMat</span> — Functional
            nanomaterials, synthesis, interfaces, and catalysis
          </li>
          <li>
            <span className="font-medium">Chemistry – An Asian Journal</span> —
            Broad chemistry with strong materials and applied chemistry content
          </li>
          <li>
            <span className="font-medium">
              Particle & Particle Systems Characterization
            </span>{" "}
            — Particles, dispersions, sensors, and related characterization
          </li>
          <li>
            <span className="font-medium">Nano Life</span> — Nanoscience,
            biomedicine, and environmental health
          </li>
        </ul>
      </div>
